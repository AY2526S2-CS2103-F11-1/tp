...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[]{
            ...
            new Person(new Name("Tan Mei Ling"),
                new Phone("92345678"),
            ...
            new Person(new Name("Ng Jun Kai"),
                new Phone("93456789"),
            ...
            new Person(new Name("Bright Future School"),
                new Phone("65556666"),
            ...
            new Person(new Name("Lim Siew Lan"),
                new Phone("95678901"),
            ...
            new Person(new Name("Tan Kok Beng"),
                new Phone("96789012"),
            ...
            new Person(new Name("SGH Medical Social Worker"),
                new Phone("62223333"),
